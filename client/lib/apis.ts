...
export const authApi = {
  ...
  resendOTP: (email: string) =>
    apiClient.post<GenericResponse>("/auth/resend-otp", { email }),
  ...
  resetPassword: (token: string, password: string, confirmPassword: string) =>
    apiClient.put<GenericResponse>(`/auth/reset-password/${token}`, { password, confirmPassword }),
...
export const cartApi = {
  getCart: () => apiClient.get<{ success: boolean; cart: Society[] }>("/cart/show"),
