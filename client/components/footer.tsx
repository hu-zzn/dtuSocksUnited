      ...
      <footer className="bg-background border-t border-border mt-20 text-foreground">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold">UnifyDTU</h3>
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground text-sm">
            © 2024 UnifyDTU. All rights reserved. | Delhi Technological University
          </div>
        </div>
      </footer>
      ...
      {showAboutModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-background text-foreground rounded-lg p-6 max-w-lg w-full border border-border max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                UnifyDTU is the central platform connecting students with various societies and clubs at Delhi
              ...
              <p>
                Whether you're interested in technical clubs, cultural societies, or sports teams, UnifyDTU helps you
